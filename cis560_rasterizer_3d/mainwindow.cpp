...
void MainWindow::keyPressEvent(QKeyEvent *e)
{
    ...
    rendered_image = rasterizer.RenderScene(this->mode, this->AA);
...
void MainWindow::on_actionLambertian_triggered() {
    this->mode = "Lambertian";
    rendered_image = rasterizer.RenderScene(this->mode, this->AA);
    DisplayQImage(rendered_image);
}

void MainWindow::on_actionToon1_triggered() {
    this->mode = "Toon1";
    rendered_image = rasterizer.RenderScene(this->mode, this->AA);
    DisplayQImage(rendered_image);
}

void MainWindow::on_actionToon2_triggered() {
    this->mode = "Toon2";
    rendered_image = rasterizer.RenderScene(this->mode, this->AA);
    DisplayQImage(rendered_image);
}
...
void MainWindow::on_actionBlinn_Phong_triggered() {
    this->mode = "Blinn-Phong";
    rendered_image = rasterizer.RenderScene(this->mode, this->AA);
    DisplayQImage(rendered_image);
}

void MainWindow::on_actionIridescent_triggered() {
    this->mode = "Iridescent";
    rendered_image = rasterizer.RenderScene(this->mode, this->AA);
    DisplayQImage(rendered_image);
}
